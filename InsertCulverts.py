...
file=open('N:/Strategic_Group/Projects/21-1547-30 Galore Creek Mine Access Study/Phase/GeoData_Working/Base Case Culverts.csv','r')
...
cursor=arcpy.da.InsertCursor('Culverts_Proposed',['Cul_Ht','Cul_Wd','Cul_DIA','Cul_Len','Cul_Skew','Type','Road_Code','SHAPE@'])
